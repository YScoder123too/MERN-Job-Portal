...
// // Used for constructing the resume download link
...
//     try {
//       // ✅ FIXED: Using api.get
//       const res = await api.get("/applications/hr");
//       setApplications(res.data);
//     } catch (err) {
//       console.error("Error fetching apps:", err);
//     } finally {
...
//     if (filename.startsWith("http")) return filename;
//     const cleanName = filename.split(/[/\\]/).pop(); 
//     // Uses the BASE_URL constant defined at the top
//     return `${BASE_URL}/api/jobs/resume/${cleanName}`;
//   };
...
// export default Applications;
import React, { useState, useEffect } from "react";
import api from "../services/api"; // ✅ FIXED: Only one '../' needed
import { Eye, Search, X, CheckCircle, XCircle, Download } from "lucide-react";
